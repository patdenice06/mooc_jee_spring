...
public class ImportData {
	...
	private static Airport mapAirport(String[] data) {
		...
		int i = 0;
		airport.setAirportId( parseNull(data[i++], Integer::parseInt) );
		...
		existingAirport.add(airport.getAirportId());
	...
	private static Airline mapAirline(String[] data) {
		...
		int i = 0;
		airline.setAirlineId( parseNull(data[i++], Integer::parseInt) );
		...
		existingAirline.add(airline.getAirlineId());
	...
	public static void main(String[] args) {
		...
		new File("./openFlightsDB.mv.db").delete();
