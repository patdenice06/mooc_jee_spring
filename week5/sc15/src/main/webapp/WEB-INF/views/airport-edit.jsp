...
<form>
  ...
  <div class="form-group">
	...
	-->
      ...
      <input type="text" value="${airport.airportId}" class="form-control" id="fId" disabled/>

  </div>
  <div class="form-group">
    <label for="fName">Name</label>
    <input 
	  type="text" value="${airport.name}"
	  class="form-control" id="fName" placeholder="Name" />
  </div>
  <div class="form-group">
    <label for="fCity">City</label>
    <input 
	  type="text" value="${airport.city}"
	  class="form-control" id="fCity" placeholder="City" />
  </div>
  <div class="form-group">
    <label for="fCountry">Country</label>
    <input 
	  type="text" value="${airport.country}"
